class QuizBrain:
    ...
    def still_hast_question(self):
        num_quest = len(self.question_list)
        return self.question_number < num_quest
    ...
    def check_answer(self, user_answer, correct_answer):
        ...
        print(f"Your current score is: {self.score_number}/{self.question_number}")
        print("\n")
